...
@$userId = $_COOKIE['id'];
//构造查询所有书籍的SQl语句
$search_sql = "select * from borrow where id = '$userId'";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row">
        <div class="col-sm-2">
            <div class="list-group side-bar">
                ...
                <a class="list-group-item active" href="borrowed.php?userId=<?php echo $userId ?>&userName=<?php echo $userName ?>">借阅记录</a>
            ...
            <div class="book-list">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        $search_sql = "select * from borrow where id = '$userId' limit $start,$page_size";
